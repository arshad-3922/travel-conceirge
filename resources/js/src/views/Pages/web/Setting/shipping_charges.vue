                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h1>settings</h1>
                                            <h2 class="blue ml-md-2">Shipping Charges </h2>
                                        </div>
                                    </div>
                                    <ValidationObserver v-slot="{ handleSubmit }">
                                        ...
                                        <div class="row mt-3 ml-md-4">
                                            <div class="col-12 ">
                                                ...
                                                <label class="event-check">Enable Shipping Charges<input
                                            ...
                                            <div class="col-12 col-md-6 col-xl-6 col-lg-6 ">
                                                ...
                                                <label for="" class="last-lb">Flat Shipping Charges</label>
                                                <input type="text" class="form-control" name="shipping_charges" v-model="setting.shipping_charges">
