            ...
            <section id="configuration">
                <div class="row card">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="ml-1 main-heading">Package Management</h1>
                            </div>
                            <div class="col-lg-6 text-right my-auto">
                                <router-link :to="{name:'admin.packages.create'}" class="general-btn d-inline-block">Create</router-link>
                            </div>
                        </div>
                                ...
                                <div class="main-tabble table-responsive">
                                    <div class="dataTables_wrapper container-fluid dt-bootstrap4">
                                       <table-search></table-search>  
                                        ...
                                        <div class="row mb-4">
                                            <template>
                                            <pagination class="float-right" :data="packages"
...
<script>
const PackageTable = () => import('./components/PackageTable.vue');
    ...
    data() {
     return {
         ...
         dateFilterCounter : 0,
            ...
            computed: {
                ...mapState('admin', ['packages', 'search', 'entries']),
            },
            components: {
                PackageTable,
            },
