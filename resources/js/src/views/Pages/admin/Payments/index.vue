                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card p-md-4 p-1">
                            <div class="row">
                                <div class="col-xl-12">
                                    <h1 class="fw-600">Payment Logs</h1>
                                </div>
                            </div>
                            ...
                            <div class="row mt-5">
                                <template>
                                <pagination class="float-right" :data="payments"
...
<script>
const PaymentTable = () => import('./components/PaymentTable.vue');
    ...
    data() {
     return {
         ...
         dateFilterCounter : 0,
            ...
            computed: {
                ...mapState('admin', ['payments', 'search', 'entries']),
            },
            components: {
                PaymentTable,
            },
