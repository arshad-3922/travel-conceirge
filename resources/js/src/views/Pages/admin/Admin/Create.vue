                                                ...
                                                <ValidationObserver v-slot="{handleSubmit}">
                                                    <form @submit.prevent="handleSubmit(create)">
                                                        <div class="row">
                                                            ...
                                                            <ValidationProvider tag="div" rules="required|confirmed:password_confirmation" name="Password" v-slot="{errors}" class="col-xl-4 col-lg-4 col-md-4 col-12">
                                                            ...
                                                            <ValidationProvider vid="password_confirmation" tag="div" rules="required" name="Confirm password" v-slot="{errors}" class="col-xl-4 col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <button type="submit" class="sub-admin-add">ADD</button>
                                                    </form>
                                                </ValidationObserver>
            </section>
        </div>
