  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)('admin', ['getAll', 'store'])), {}, {
    ...
    uploadImage: function uploadImage(e, index) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var file, reader, fd, params, _yield$_this2$store, data;
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                reader.onload = function (event) {
                  ...
                  _this2.image = _this2.cms.images[index].image;
                };

                reader.readAsDataURL(file);
                fd = new FormData();
                fd.append("image", _this2.cms.images[index].image);
                params = {
                  route: "api/cmss/update/".concat(index),
                  mutation: 'SET_CMS',
                  variable: 'data',
                  data: fd
                };
