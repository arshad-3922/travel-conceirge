...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)('admin', ['getAll', 'store'])), {}, {
    ...
    uploadImage: function uploadImage(e, index, id) {
      var _this2 = this;
      ...
      reader.onload = function (event) {
        ...
        _this2.replaceImage.push(_this2.cms.images[index].image);

        if (_this2.removeImages != null) {
          _this2.setImage(id);
        }
      };
    ...
    setImage: function setImage(id) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var fd, params, _yield$_this3$store, data;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                fd = new FormData();
                fd.append('image', _this3.replaceImage);
                params = {
                  route: "api/cmss/update/".concat(id),
                  mutation: 'SET_CMS',
                  variable: 'data',
                  data: fd
                };
              ...
              case 6:
                _yield$_this3$store = _context2.sent;
              ...
              case 11:
                ...
                _this3.$snotify.error(_context2.t0);
    ...
    deleteImage: function deleteImage(id) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3() {
        var fd, params, _yield$_this4$store, data;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                fd = new FormData();
                fd.append('image', _this4.replaceImage);
                params = {
                  route: "api/cmss/delete/".concat(id),
                  mutation: 'SET_CMS',
                  variable: 'data',
                  data: fd
                };
              ...
              case 6:
                ...
                if (data.status) {
                  _this4.$snotify.success(data.message);
              ...
              case 11:
                ...
                _this4.$snotify.error(_context3.t0);
    ...
    removeImage: function removeImage(index, id) {
      ...
      this.removeImages.push(this.cms.images[index].image);
    }
  })
});
