          ...
          [
            _vm._l(_vm.payments.data, function(payment, index) {
              return _c("tr", { key: index }, [
                ...
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(_vm.formatDate(_vm.user.created_at)))]),
                _vm._v(" "),
                _c("td", [_vm._v("Basic")]),
                _vm._v(" "),
                _c("td", [
                  _vm._v(_vm._s(_vm.user.block_status ? "Active" : "Inactive"))
                ]),
                _vm._v(" "),
                _c("td", [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(
                              "\n                                                                    " +
                                _vm._s(
                                  _vm.user.block_status ? "Inactive" : "Active"
                                ) +
                                "\n                                                                "
                            )
                          ]
