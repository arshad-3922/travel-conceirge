...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)('admin', ['getAll'])), {}, {
    ...
    uploadsecondaryImages: function uploadsecondaryImages(e) {
      var _this2 = this;

      Array.from(e.target.files).forEach(function (file) {
        if (_this2.cmsImages.images.length === 3) {
          _this2.$snotify.warning('Only 3 pictures can be uploaded');

          return;
        }

        _this2.cmsImages.images.push(file);

        var reader = new FileReader();

        reader.onload = function (e) {
          _this2.base64Images.push(e.target.result);
        };
                ...
                _c("form", { attrs: { action: "#" } }, [
                  _vm.base64Images.length > 0
                    ? _c(
                        ...
                        _vm._l(_vm.base64Images, function(media, index) {
                          return _c(
                            "div",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "d-flex align-items-center mb-1 mr-2" }, [
      _c(
        "button",
        {
