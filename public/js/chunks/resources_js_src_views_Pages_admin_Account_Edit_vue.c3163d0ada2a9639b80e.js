        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                fd = new FormData();
                fd.append('first_name', _this2.profile.first_name);
                fd.append('last_name', _this2.profile.last_name);
              ...
              case 8:
                ...
                if (data) {
                  _this2.$snotify.success('admin profile updated'); //this.$router.push({name: 'admin.account.index'});
